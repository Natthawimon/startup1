...
import {
  ...
  export default function Homemodal1({ navigation }) {
       ...
       <Button 
          ...
          ></Button>
              <Text style={{
                ...
                marginTop:10,
                left:80
              }}>นักกฎหมายหรือที่ปรึกษาทางกฎหมาย</Text>
              <Text style={{
                color: "#000000", 
                fontSize: 13,
                fontFamily: 'NotoSansThai-VariableFont_wdth,wght',
                marginTop:0,
                left:65
              }}>ทำได้เพียงให้คำปรึกษาข้อกฎหมายเบื้องต้น</Text>
              <Text style={{
                color: "#000000", 
                fontSize: 13,
                fontFamily: 'NotoSansThai-VariableFont_wdth,wght',
                marginTop:0,
                left:70
              }}> ตามข้อเท็จจริงไม่สามารถให้คำปรึกษาใน</Text>
              <Text style={{
                color: "#000000", 
                fontSize: 13,
                fontFamily: 'NotoSansThai-VariableFont_wdth,wght',
                marginTop:0,
                left:93
              }}>กระบวนการดำเนินการทางศาลได้</Text>
            ...
            <Button color="#FBD653"
                title="ต่อไป" 
                onPress={() => navigation.navigate('Homemadal2')}
                titleStyle={{
